...
def main():
    ...
    print(loco_results)
    loco_results.to_csv('LOOC_results_BMIQ.csv', index=False)
    print("Saved LOCO results to LOOC_results_BMIQ.csv")
    ...
    print(f"Saving {var_clock.shape[0]} non-zero coefficients to VAR_model_BMIQ.csv")
    var_clock.to_csv('VAR_model_BMIQ.csv')
